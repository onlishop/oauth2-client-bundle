...
namespace Onlishop\OAuth2ClientBundle\Tests\Security\Authenticator;
...
use Onlishop\OAuth2ClientBundle\Security\Authenticator\SocialAuthenticator;
use Onlishop\OAuth2ClientBundle\Client\OAuth2Client;
use Onlishop\OAuth2ClientBundle\Security\Exception\IdentityProviderAuthenticationException;
use Onlishop\OAuth2ClientBundle\Security\Exception\InvalidStateAuthenticationException;
use Onlishop\OAuth2ClientBundle\Security\Exception\NoAuthCodeAuthenticationException;
