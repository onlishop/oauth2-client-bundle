...
namespace Onlishop\OAuth2ClientBundle\Tests\Security\User;

use Onlishop\OAuth2ClientBundle\Security\User\OAuthUser;
use Onlishop\OAuth2ClientBundle\Security\User\OAuthUserProvider;
